...
wget https://raw.githubusercontent.com/minionstore/c/main/config/menu.zip
unzip menu.zip
chmod +x menu/*
...
wget -q https://raw.githubusercontent.com/minionstore/c/main/versionbaru -O /usr/local/sbin/version
